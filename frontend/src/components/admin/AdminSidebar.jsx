function AdminSidebar({ onSelect }) {
  return (
    <div className="sidebar">
      ...
      <button onClick={() => onSelect("user-add")}>Crear Usuario</button>
      <button onClick={() => onSelect("user-edit")}>Editar Usuario</button>
      <button onClick={() => onSelect("user-delete")}>Eliminar Usuario</button>
      <br />
      <br />
      {/* Sección Libros */}
      ...
      <button onClick={() => onSelect("book-edit")}>Editar Libro</button>
      <button onClick={() => onSelect("book-delete")}>Eliminar Libro</button>
      <br />
      <br />
